                ...
                <div class="col-md-12">
                    ...
                    <form method="GET" action="">
                        ...
                        <div class="form-group">
                            ...
                            <a href="cetak-laporan.php?<?= $_SERVER['QUERY_STRING'] ?>" class="btn btn-sm btn-success">Cetak
                                Laporan Sesuai Tanggal</a>
                            <br/>
                            <br/>
                            <p><b>Pilih Laporan</b></p>
                            <a target="_blank" class="btn btn-sm btn-success"
                               href="<?php echo "cetak-laporan.php?laporan=harian"; ?>">Cetak Laporan Harian</a>
                            <a target="_blank" class="btn btn-sm btn-success"
                               href="<?php echo "cetak-laporan.php?laporan=bulanan"; ?>">Cetak Laporan Bulanan</a>
                            <a target="_blank" class="btn btn-sm btn-success"
                               href="<?php echo "cetak-laporan.php?laporan=tahunan"; ?>">Cetak Laporan Tahunan</a>
                        </div>
                    </form>
                    <hr>
