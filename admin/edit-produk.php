                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <form method="POST" enctype="multipart/form-data"
                                              action="<?= $base_url; ?>/admin/edit-foto-produk.php">
                                            <?php if ($p['foto_produk'] != ""): ?>
                                                <img src="<?= $base_url; ?>/produk/<?= $p['foto_produk']; ?>"
                                                     width="200" height="200"/>
                                                <input name="foto_produk" type="file" class="form-control">
                                            <?php else: ?>
                                                <input style="margin-top:200px;" name="foto_produk" type="file"
                                                       class="form-control">
                                            <?php endif; ?>
                                            <input name="id_foto_produk" type="hidden" class="form-control"
                                                   value="<?= $p['id_foto_produk'] ?>">
